...
class Directed_WeightedGraphAlgorithmsTest {
    ...
    @Test
    void isConnected() {
        Directed_WeightedGraphAlgorithms alg2 = new Directed_WeightedGraphAlgorithms("1000Nodes.json");
        assertEquals(alg2.isConnected(), true);
    }
    ...
    void center() {
        ...
        assertEquals(8, ans1);
        Directed_WeightedGraphAlgorithms alg2 = new Directed_WeightedGraphAlgorithms("1000Nodes.json");
        assertEquals(alg2.center().getKey(), 362);
    }
    ...
    void tsp() {
        ...
        cities.add(alg2.getGraph().getNode(1));
        cities.add(alg2.getGraph().getNode(2));
        cities.add(alg2.getGraph().getNode(3));
        cities.add(alg2.getGraph().getNode(4));
        cities.add(alg2.getGraph().getNode(5));
        alg2.tsp(cities);
    }
